 ...
 * @author igoens
 */
public class OperatorViewRD extends JLabel implements TableCellRenderer {
    
    private static final long serialVersionUID = -3355085774838784504L;

    private ListSelectionModel selectionModel;

    public OperatorViewRD() {
        setOpaque(true);
    }
